"""
Django settings for testapiautosetting_123657 project.
...
ROOT_URLCONF = 'testapiautosetting_123657.urls'
...
WSGI_APPLICATION = 'testapiautosetting_123657.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_123657 API",
    "DESCRIPTION": "API documentation for testapiautosetting_123657 App",
    "VERSION": "v1",
}
