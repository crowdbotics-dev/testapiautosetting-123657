...
## Project Structure
    ...
    ├── testapiautosetting_123657  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123657`
...
2. Clone this repo and `cd testapiautosetting_123657`
